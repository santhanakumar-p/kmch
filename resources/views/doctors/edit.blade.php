        ...
        <div class="row justify-content-center">
            <div class="col col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('doctors.update', ['id' => $doctor->id]) }}" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="qualification" id="qualification" class="form-control" value="{{ $doctor->qualification }}"
                                    placeholder="Enter qualification">
                            </div>
                            <div class="mb-2">
                                <label for="experience" class="form-label">Experience</label>
                                <input type="number" name="experience" id="experience" class="form-control" value="{{ $doctor->experience }}"
                            ...
                            <div class="mb-2">
                                ...
                                <select name="department_id" id="department-id" class="form-control">
                                    ...
                                    @foreach ($departments as $department)
                                        <option value="{{ $department->id }}" @selected( $department->id == $doctor->department_id )>{{ $department->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="datetime-local" name="shift_start_date_time" id="shift-start-date-time" value="{{ $doctor->shift_start_date_time }}"
                                    class="form-control">
                            </div>
                            <div class="mb-2">
                                <label for="shift-end-date-time" class="form-label">Shift End Date Time</label>
                                <input type="datetime-local" name="shift_end_date_time" id="shift-end-date-time" value="{{ $doctor->shift_end_date_time }}"
                                    class="form-control">
                            </div>
                            <div class="mb-2">
